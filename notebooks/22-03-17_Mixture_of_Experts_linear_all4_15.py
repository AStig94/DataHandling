...
#%% Pretrained y_plus 15 and pr0.025

model_name_pr0025 = 'youthful-wave-72'
...
#%% Pretrained y_plus 15 and pr0.2

model_name_pr02 = 'silvery-dragon-71'
...
#%% Pretrained y_plus 15 and pr0.71

model_name_pr071 = 'cool-bird-51'
...
#%% Pretrained y_plus 15 and pr1

model_name_pr1 = 'true-salad-89'
...
wandb.init(project="Thesis",notes="Mixture of Experts Linear AllPr y+=15")
