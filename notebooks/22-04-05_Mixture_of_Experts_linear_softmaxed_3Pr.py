...
#%%
input_features=['u_vel','v_vel','w_vel','pr_mix_0025_02_071']
padding_layers=8
...
output = keras.layers.Add()([hadamard0, hadamard1,hadamard2])
...
import xarray as xr 
var=['u_vel','v_vel','w_vel','pr_mix_0025_02_071']
target=['pr0.025_flux_mix_pr0.2_pr0.71']
normalized=False
y_plus=30
