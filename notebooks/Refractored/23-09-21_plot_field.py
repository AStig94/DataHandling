...
#%%
model=keras.models.load_model('/home/au567859/DataHandling/models/trained/CNN_like_gustanoi_Conv2DTranspose.h5')

test=load('/home/au567859/DataHandling/data/processed/y_plus_15_test',repeat=(1))
