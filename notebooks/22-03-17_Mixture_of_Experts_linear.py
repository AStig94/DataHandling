...
#%%
input_features=['u_vel','v_vel','w_vel','pr_mix_0025_071']
padding_layers=8
...
cnn9=tf.keras.layers.Conv2DTranspose(2,1)(conc5)
...
hadamard1 = keras.layers.Multiply()([FCN_pr071_output, G1])

output = keras.layers.Add()([hadamard0, hadamard1])
...
import xarray as xr 
var=['u_vel','v_vel','w_vel','pr_mix_0025_071']
target=['pr0.025_flux_mix_pr0.71']
normalized=False
y_plus=30
