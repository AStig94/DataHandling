...
#%% Pretrained y_plus 75 and pr0.025

model_name_pr0025 = 'flowing-planet-79'
...
#%% Pretrained y_plus 75 and pr0.2

model_name_pr02 = 'rich-moon-81'
...
#%% Pretrained y_plus 75 and pr0.71

model_name_pr071 = 'driven-gorge-80'
...
#%% Pretrained y_plus 75 and pr1

model_name_pr1 = 'divine-glitter-86'
...
wandb.init(project="Thesis",notes="Mixture of Experts Linear AllPr y+=75")
